...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <button style="margin-left: 20%" data-toggle="modal"
            data-target="#addBuilding" class="btn btn-primary"
            type="button">Додати будинок
    </button>
    <table class="table table-hover">
        ...
        <c:forEach var="building" items="${buildings}">
            ...
            <tr>
                ...
                <td>${building.street.streetName}</td>
                <td>${building.buildNumber}</td>
                <td>${building.buildingType.kind}</td>
                <td>
                ...
                <div>
                    <form method="post">
                        <table class="table">
                            <tr>
                                <td>Номер будинку</td>
                                <td><input type="text" name="buildingNumber"></td>
                            </tr>
                            <tr>
                                <div class="form-group">
                                    <label for="sel1">Вулиця:</label>
                                    <select class="form-control" name="street" id="sel1">
                            ...
                            <tr>
                                <div class="form-group">
                                    <label for="sel2">Тип:</label>
                                    <select class="form-control" name="buildType" id="sel2">
                                        <c:forEach var="buildType" items="${buildTypes}">
                                            <option value="${buildType.id}">${buildType.kind}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </tr>
